...
import { cn } from "/src/animations/lib/utils.ts";
  ...
  (
    {
      ...
      spinSpeed = 14.0,
      offset = [0.0, 0.0],
      color1 = "#f38aff", // Original Balatro red (0.871, 0.267, 0.231)
      color2 = "#ff97d6", // Original Balatro blue (0.0, 0.42, 0.706)
      color3 = "#5200d3", // Original Balatro dark (0.086, 0.137, 0.145)
      contrast = 3.5,
      lighting = 2,
      spinAmount = 0.25,
      pixelFilter = 745.0,
    ...
    return (
      <div ref={ref} className={cn("w-full h-full -z-30 fixed")} {...props}>
        <Canvas
